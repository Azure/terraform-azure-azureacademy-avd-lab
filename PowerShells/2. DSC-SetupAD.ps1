...
# & './2. DSC-SetupAD.ps1' -DomainName "contoso.com" -Username "localadmin" -SecurePassword $SecurePassword
...
SetupADDomain -Credential $Credentials -SafeModePassword $Credentials -DomainName $DomainName -ConfigurationData $ConfigurationData
Start-Dscconfiguration -Wait -Verbose -Path ./SetupADDomain -Force
